      ...
      <div class="row">
        <div class="col-xl-6 col-lg-8">
          <div class="banner-one__content">
            ...
            <h3 class="banner-one__title">We Create the <br> <span>Jewellery</span> for <br> Life.</h3><!-- /.banner-one__title -->
            <p class="banner-one__text">We are committed to providing our customers with <br> 愛、そして貴重な体験。 <br> </p>
            <!-- /.banner-one__text -->
            <a href="#features" class="banner-one__btn thm-btn "><span>Beginnen</span></a><!-- /.thm-btn -->
