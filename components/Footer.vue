          ...
          <div class="row">
            <div class="col-lg-3">
              <div class="footer-widget footer-widget__about">
                ...
                <p class="footer-widget__contact"><a href="tel:+86-138-0013-8000">+86-138-0013-8000</a></p>
                <!-- /.footer-widget__contact -->
                <p class="footer-widget__contact"><a href="mailto:needhelp@example.com">needhelp@example.com</a>
                <p class="footer-widget__contact">西城区府右街乙27号<br>Z·N·H</p><!-- /.footer-widget__contact -->
              </div><!-- /.footer-widget -->
            </div><!-- /.col-lg-2 -->
      ...
      <div class="site-footer__bottom">
        <div class="container">
          <div class="inner-container text-center">
            <p class="site-footer__copy">&copy; copyright 2023 by <a href="#">Eternal Aura</a></p>
            <!-- /.site-footer__copy -->
          </div><!-- /.inner-container -->
        </div><!-- /.container -->
